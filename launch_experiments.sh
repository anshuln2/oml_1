...
do
        ...
        python check_fingerprints.py --model_path $model_path --num_fingerprints $num_fingerprints --fingerprints_file_path /home/ec2-user/anshuln/oml_1/generated_data/key-32-sig-32-temperature-0.5-first_token-word-key_sig-independent-instr_tuned.json  --wandb_run_name "llm_fingerprinting_lora" 

    for lora_rank in 2 4 8 16 32;
    do
        deepspeed --num_gpus 4 finetune_multigpu.py --num_fingerprints $num_fingerprints --use_lora --lora_rank $lora_rank --wandb_run_name "llm_fingerprinting_lora" --learning_rate 1e-3
        # Check fingerprints next
