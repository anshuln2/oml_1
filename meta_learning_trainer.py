...
def ft_meta_training_loop(
    ...
    model_averaging_lambda: float = 0.0,
    ...
    **kwargs,
    ...
    for train_step in range(max_steps):
        ...
        if model_averaging_lambda > 0 and train_step % model_averaging_every_k_steps == 0 and train_step > 0:
            model_storage.merge_original_model(model, model_averaging_lambda)
